            ...
            <div className="prose prose-lg max-w-4xl">
              ...
              <ol>
                <li className="text-gray-600 text-lg mb-6 text-justify ">
                  <strong>Все ли устраивает в жизни?</strong>
                  <br />
              ...
              <ol start={2}>
                <li className="text-gray-600 text-lg mb-6 text-justify ">
                  <strong>Проблемы в душевной организации?</strong>
                  <br />
              ...
              <ol start={3}>
                <li className="text-gray-600 text-lg mb-6 text-justify">
                  <strong>
                    Исчезнут ли проблемы, если Вы окажитесь на необитаемом
                    острове?
                  </strong>
                  <br />
                  <em>- Нет.</em> Вам не сюда. Обратитесь к другому специалисту.
              ...
              <p className="text-gray-600 text-lg mb-6 text-justify border-b">
                <em>
                  - Фокусирую внимание на чем угодно, кроме собеседника –{" "}
                </em>
