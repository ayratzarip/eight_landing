        ...
        <div className="container mx-auto px-4 py-8 ">
          <div className="bg-white rounded-xl shadow-2xl p-8 mb-8">
            ...
            <div className="mb-8 flex flex-col lg:flex-row items-center gap-8">
              <div className="w-full lg:w-1/3 mb-6 lg:mb-0 lg:ml-36 flex justify-center lg:justify-start">
                <Image
                  src="/assets/author.png"
                  alt="Зарипов Айрат Ахмадуллович"
                  width={1000}
                  height={1000}
                  className="w-full max-w-[280px] sm:max-w-[320px] md:max-w-[360px] lg:max-w-xs h-auto object-contain"
                />
              </div>
              <div className="w-full lg:w-2/3 flex flex-col justify-center">
                <div>
                  <p className="text-gray-600 text-lg mb-6 text-center lg:mr-36">
                    Привет! Меня зовут Айрат Зарипов.
                  </p>
                  <p className="text-gray-600 text-lg mb-6 text-justify lg:mr-36">
